                ...
                <div class="row">
                    ...
                    <div class="col-7 table-responsive">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <th>DTS No.</th>
                                <th>{{ $internals->dts }}{{ $internals->id}}</th>
                            </tr>
                            <tr>
                    ...
                    <div class="col-5 table-responsive">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <th rowspan="2">URL</th>
                                <td><span class="">{!! QrCode::size(70)->backgroundColor(255,255,255)->generate('ARTA-EDTS URL:' .' http://10.20.29.32/files/iv/'.$internals->id) !!}</span></td>
                            </tr>
                        </table>
