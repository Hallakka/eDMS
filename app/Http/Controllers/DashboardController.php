...
class DashboardController extends Controller
{
    ...
    public function index() {
        ...
        $allextopen = Externals::where('status', '=', 'Open')->count();
        $allextclosed = Externals::where('status', '=', 'Closed')->count();
        ...
        $allintopen = Externals::where('status', '=', 'Open')->count();
        $allintclosed = Externals::where('status', '=', 'Closed')->count();
        ...
        return view('dashboard',  [
            ...
            'allextopen' => $allextopen,
            'allextclosed' => $allextclosed,
            ...
            'allintopen' => $allintopen,
            'allintclosed' => $allintclosed,
