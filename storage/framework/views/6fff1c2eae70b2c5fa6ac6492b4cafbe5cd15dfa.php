...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select wire:model.defer="modeoftrans" name="modeoftrans" class="form-control rounded-0">
                                <option value="" selected>-</option>
                                    <?php $__currentLoopData = $inmodeoftrans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modeoftrans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/livewire/files/forward/forward-in-docs.blade.php ENDPATH**/ ?>