...
<?php $__env->startSection('content'); ?>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="m-1">Edit User <span class="ml-2" style="font-size:18px;color:#737373;"><?php echo e($user->name); ?></span></h4>
                    </div>
                    <!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                  ...
                  <div class="card card-outline card-info">
                        <div class="card-body">
                            ...
                            <nav aria-label="breadcrumb" class="my-1">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active" aria-current="page">User ID: <?php echo e($user->id); ?></li>
                                </ol>
                            </nav>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="department" id="department" class="form-control">
                                            <option value="<?php echo e($user->department); ?>" selected><?php echo e($user->department); ?></option>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="office" id="office" class="form-control">
                                            <option value="<?php echo e($user->office); ?>" selected><?php echo e($user->office); ?></option>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="div_unit" id="div_unit" class="form-control">
                                            <option value="<?php echo e($user->div_unit); ?>" selected><?php echo e($user->div_unit); ?></option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="department_id" id="department_id" class="form-control">
                                            <option value="<?php echo e($user->department_id); ?>" selected><?php echo e($user->department); ?></option>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="office_id" id="office_id" class="form-control">
                                            <option value="<?php echo e($user->office_id); ?>" selected><?php echo e($user->office); ?></option>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        <label>Confirm Director/Personnel</label>
                                        <select name="div_unit_id" id="div_unit_id" class="form-control">
                                            <option value="<?php echo e($user->div_unit_id); ?>" selected><?php echo e($user->div_unit); ?></option>
                                ...
                                <div class="form-group col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="approved" id="approved" class="form-control">
                                            <option value="<?php echo e($user->approved); ?>" selected><?php echo e($user->approved); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>