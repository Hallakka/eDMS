...
} elseif ($_instance->childHasBeenRendered('aQlYSiM')) {
    $componentId = $_instance->getRenderedChildComponentId('aQlYSiM');
    $componentTag = $_instance->getRenderedChildComponentTagName('aQlYSiM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aQlYSiM');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('aQlYSiM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/layouts/app.blade.php ENDPATH**/ ?>