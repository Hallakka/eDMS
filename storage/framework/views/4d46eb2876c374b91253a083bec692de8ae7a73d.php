...
<?php $__env->startSection('content'); ?>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-3">
                  <div class="col-sm-6">
                      <h5 class="m-1">External Documents<span class="ml-2" style="font-size:18px;color:#737373;">Department</span></h5>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/livewire/files/department/external.blade.php ENDPATH**/ ?>