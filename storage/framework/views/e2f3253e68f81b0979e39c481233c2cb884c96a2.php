...
<html>
 ...
 <body>
    ...
    <a href="<?php echo e(url('files/office/internal')); ?>">
      <button type="button" class="btn btn-default btn-block btn-flat">View All &nbsp<i class="fas fa-arrow-circle-right"></i></button>
    </a>

 </body>
</html>
<?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/livewire/files/office/internal-chart-js.blade.php ENDPATH**/ ?>