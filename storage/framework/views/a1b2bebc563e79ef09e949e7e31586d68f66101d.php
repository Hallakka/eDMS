                    ...
                    <table id="newinternal" class="table table-bordered table-striped table-hover">
                          ...
                          <?php $__currentLoopData = $inroute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inroute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                              ...
                              <td><?php echo e($inroute->assigned_date); ?></td>
                              <td><?php echo e($inroute->routed_by); ?> <br /><?php echo e($inroute->routed_by_div_unit); ?></td>
                              <td><?php echo e($inroute->subject); ?></td>
                              ...
                              <td><a class="btn btn-primary btn-sm mr-0" href="<?php echo e(route('iv.index',$inroute->dts_no)); ?>">View</a></td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/livewire/files/forward/n/internal.blade.php ENDPATH**/ ?>