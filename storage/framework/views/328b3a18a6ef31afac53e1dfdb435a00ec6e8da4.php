 ...
 <head>
  ...
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    <script type="text/javascript">
      var inroute_office_analytics = <?php echo $inroute_office_status; ?>
        ...
        google.charts.setOnLoadCallback(drawExternalOfficeRouteChart);
          ...
          {
            var inroute_office_data = google.visualization.arrayToDataTable(inroute_office_analytics);
            var options = {
              title :'',
            ...
            var chart = new google.visualization.PieChart(document.getElementById('inroute_office_donutchart'));
            chart.draw(inroute_office_data, options);
          }
 ...
 <body>
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12" align="">
      <div id="inroute_office_donutchart"></div>
    </div>
  </div>
  <a href="<?php echo e(url('files/office/iad')); ?>">
...
<?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/livewire/files/office/inroute-chart-js.blade.php ENDPATH**/ ?>