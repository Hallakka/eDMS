<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between navbar navbar-expand navbar-white navbar-light h-13">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <!-- <li class="nav-item dropdown">
                    <a class="nav-link" href="<?php echo e(url('files/n/external')); ?>">
                            ...
                            <?php else: ?>
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                        <?php echo e(Auth::user()->name ?? 'Reset Password'); ?>
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div>
                    <div class="font-medium text-base text-gray-800"><?php echo e(Auth::user()->name ?? 'Reset Password'); ?></div>
                    <div class="font-medium text-sm text-gray-500"><?php echo e(Auth::user()->email ?? 'Reset Password'); ?></div>
                </div>
            </div>
...
<?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/navigation-menu.blade.php ENDPATH**/ ?>