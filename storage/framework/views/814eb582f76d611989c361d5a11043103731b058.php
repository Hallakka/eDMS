                ...
                <div class="row">
                    ...
                    <?php $__currentLoopData = $inroute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inroute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 table-responsive">
                                <table class="table table-bordered table-striped">
                                    <tr>
                                        ...
                                        <td><?php echo e($inroute->dts); ?><?php echo e($inroute->dts_no); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($inroute->file_upload > 0): ?>
                                            <?php if(Auth::check() && (Auth::user()->name == $inroute->personnel)): ?>
                                                <a href="<?php echo e(asset('/storage/'.$inroute->file_upload)); ?>" target="_blank" ><i>private</i></a>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($inroute->sharepoint_link > 0): ?>
                                            <?php if(Auth::check() && (Auth::user()->name == $inroute->personnel)): ?>
                                                <a href="<?php echo e($inroute->sharepoint_link); ?>" target="_blank" ><i>private</i></a>
                                                    <?php else: ?> <i>private</i>
                                            <?php endif; ?>
                                        <?php endif; ?></td>
                                    </tr>
                                ...
                                <form action="<?php echo e(route('forward.inroute.update',$inroute->id)); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($inroute->status); ?></td>
                                        </tr>
                                        <tr>
                                            <th>Outgoing</th>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <form action="<?php echo e(route('forward.inroute.open',$inroute->id)); ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="callout callout-light col-lg-12 col-md-12 col-sm-12" align="center">
                                            ...
                                            <p>Assigned to <?php echo e($inroute->personnel); ?> (<?php echo e($inroute->div_unit); ?>)</p>
                                        </div>
                                    </form>
                                </div>
                                <?php endif; ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 mb-4 mt-2">
                            <p class="my-0" style="color:#BFBFBF;"><i class="fas fa-level-up-alt fa-lg"></i> <span class="text-muted well well-sm shadow-none ml-3" style="font-size:15px;">Routed at: <strong><?php echo e($inroute->created_at); ?></strong> / by <strong><?php echo e($inroute->routed_by); ?></strong> (<?php echo e($inroute->routed_by_div_unit); ?>)</span></p>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/livewire/files/forward/inroute/print.blade.php ENDPATH**/ ?>