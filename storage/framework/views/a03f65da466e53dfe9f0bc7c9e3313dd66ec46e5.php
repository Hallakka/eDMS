...
<?php $__env->startSection('content'); ?>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-3">
                  <div class="col-sm-6">
                      <h5 class="m-1">External Documents<span class="ml-2" style="font-size:18px;color:#737373;">Division - Unit</span></h5>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="card card-outline card-info">
                    ...
                    <table id="divunitexternal" class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              <th hidden>ID</th>
                          ...
                          <?php $__currentLoopData = $externals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $externals): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                              ...
                              <td><?php echo e($externals->personnel); ?> <br /><?php echo e($externals->div_unit); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/livewire/files/div-unit/external.blade.php ENDPATH**/ ?>