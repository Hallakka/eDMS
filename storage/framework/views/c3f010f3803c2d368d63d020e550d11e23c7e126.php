                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::text('email', null, array('placeholder' => 'Email Address','class' => 'form-control')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\doctracker\resources\views/admin/users/create.blade.php ENDPATH**/ ?>